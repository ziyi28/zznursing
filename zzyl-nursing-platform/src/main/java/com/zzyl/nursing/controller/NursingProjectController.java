...
public class NursingProjectController extends BaseController
{
    ...
    @ApiImplicitParams({
        @ApiImplicitParam(name = "nursingProject", value = "查询条件对象", required = true, dataType = "NursingProject", paramType = "query", dataTypeClass = NursingProject.class)
    })
    ...
    @PutMapping
    public AjaxResult edit(@RequestBody @ApiParam("修改后的护理项目对象") NursingProject nursingProject)
    {
    ...
    @DeleteMapping("/{ids}")
    public AjaxResult remove(@PathVariable @ApiParam("要删除的护理项目ID数组") Long[] ids)
    {
